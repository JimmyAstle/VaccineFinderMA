...
| Site                | Status         |
| ------------------- | -------------- |
| <img alt="" src="https://favicons.githubusercontent.com/www.cvs.com" height="13"> [CVS](https://www.cvs.com/immunizations/covid-19-vaccine)               | :white_check_mark: Available AGAWAM BELCHERTOWN BOSTON BOURNE BRAINTREE BROCKTON CHELSEA CHESTNUT HILL DANVERS DEDHAM DORCHESTER DRACUT EAST BOSTON EVERETT FALL RIVER FITCHBURG FOXBOROUGH FRAMINGHAM GEORGETOWN GLOUCESTER GREAT BARRINGTON GREENFIELD HADLEY HANOVER HARWICH HAVERHILL HOLBROOK HOLYOKE HYANNIS HYDE PARK KINGSTON LONGMEADOW LOWELL LYNN MALDEN MARBLEHEAD MASHPEE MATTAPAN MEDFORD METHUEN MIDDLEBOROUGH MIDDLETON NEEDHAM NEW BEDFORD NEWBURYPORT NEWTON NORTH ATTLEBOROUGH NORTH DARTMOUTH NORTH EASTON NORTHAMPTON ORLEANS PALMER PEABODY PLYMOUTH PROVINCETOWN RANDOLPH READING REVERE ROSLINDALE ROWLEY SALEM SALISBURY SANDWICH SAUGUS SEEKONK SOUTH EASTON SOUTH HAMILTON SOUTH WEYMOUTH SOUTH YARMOUTH SOUTHBRIDGE SOUTHWICK SPRINGFIELD STOUGHTON STURBRIDGE SWANSEA TAUNTON WAREHAM WATERTOWN WAYLAND WEST BRIDGEWATER WEST NEWTON WEST SPRINGFIELD WESTBOROUGH WESTFIELD WESTPORT WESTWOOD WEYMOUTH WILBRAHAM WINCHESTER WINTHROP WORCESTER       |
<!--end: status pages-->
