...
| Site                | Status         |
| ------------------- | -------------- |
| <img alt="" src="https://favicons.githubusercontent.com/www.cvs.com" height="13"> [CVS](https://www.cvs.com/immunizations/covid-19-vaccine)               | :white_check_mark: Available AGAWAM FALL RIVER HYANNIS NEW BEDFORD NORTH DARTMOUTH PROVINCETOWN SANDWICH WAREHAM WESTPORT       |
<!--end: status pages-->
