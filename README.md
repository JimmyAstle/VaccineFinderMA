...
<!--start: status pages-->
**Last Updated**: 2021-04-10 05:22 AM

| Site                | Status         |
| ------------------- | -------------- |
| <img alt="" src="https://favicons.githubusercontent.com/www.cvs.com" height="13"> [CVS](https://www.cvs.com/immunizations/covid-19-vaccine)               | :white_check_mark: Available ATTLEBORO DRACUT FRAMINGHAM LOWELL LYNN MALDEN MEDFORD METHUEN PEABODY SEEKONK WALTHAM WATERTOWN WORCESTER       |
<!--end: status pages-->
