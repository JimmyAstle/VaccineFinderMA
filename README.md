...
<!--start: status pages-->
**Last Updated**: 2021-04-18 11:48 AM

| Site                | Status         |
| ------------------- | -------------- |
| <img alt="" src="https://favicons.githubusercontent.com/www.cvs.com" height="13"> [CVS](https://www.cvs.com/immunizations/covid-19-vaccine)               | :white_check_mark: Available FALL RIVER NEW BEDFORD WESTPORT       |
<!--end: status pages-->
